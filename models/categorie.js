...
class Categorie {
    ...
    static avoirNomCatégories(cb) {
        let query = connection.query('SELECT NumCatégorie,LibelléCatégorie FROM catégorie', (error, results) => {
    ...
    static avoirLibellé(num, cb) {
        let query = connection.query('SELECT LibelléCatégorie FROM catégorie WHERE NumCatégorie = ?', num, (error, results) => {
            if (error) throw error;
            cb(results[0]);
        });
    }
    ...
    static vérifierLibellé(lib, cb) {
        let query = connection.query('SELECT NumCatégorie,LibelléCatégorie FROM catégorie WHERE LibelléCatégorie = ?', lib, (error, results) => {
            if (error) throw error;
            cb(results);
        });
    }
    ...
    static vérifierNumCatégorie(num, cb) {
        let query = connection.query('SELECT COUNT(*) as tot FROM catégorie WHERE NumCatégorie = ?', num, (error, results) => {
            if (error) throw error;
            cb(results[0].tot);
        });
    }
    ...
    static ajouterCatégorie(lib, cb) {
        let query = connection.query('INSERT INTO catégorie SET Libellécatégorie = ?', lib, (error, results) => {
            if (error) throw error;
            cb(results);
        });
    }
    ...
    static supprimerCatégorie(num, cb) {
        let query = connection.query('DELETE FROM catégorie WHERE NumCatégorie = ?', num, (error, results) => {
            if (error) throw error;
            cb(results);
        });
    }
    ...
    static modifierCatégorie(libCat, num, cb) {
        let query = connection.query('UPDATE catégorie SET LibelléCatégorie = ? WHERE NumCatégorie = ?', [libCat, num], (error, results) => {
            if (error) throw error;
            cb(results);
        });
    }
